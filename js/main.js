...
function formEditDetailTravel() {
    ...
    if (formEditDetailTravel.style.display == "none") {
        formEditDetailTravel.style.display = "block";
        detailTravel.style.display = "none";
    } else {
        formEditDetailTravel.style.display = "none";
        detailTravel.style.display = "block";
    }
}