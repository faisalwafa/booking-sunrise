...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!$res['success']) {
        ...
        if (isset($_SESSION['user_id'])) {
            ...
            $sql_add_booking_city = "INSERT INTO wpzu_trav_city_bookings ( travel_id, first_name, last_name, email, country, phone, pax, pick_up_date, pick_up_time, pick_up_location, special_requirement, total_price, user_id, booking_no ) VALUES (
            ...
            $sql_add_booking_city = "INSERT INTO wpzu_trav_city_bookings ( travel_id, first_name, last_name, email, country, phone, pax, pick_up_date, pick_up_time, pick_up_location, special_requirement, total_price, booking_no ) VALUES (
